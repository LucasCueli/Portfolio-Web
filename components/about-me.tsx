        ...
        <div className="p-6 md:px-12 md:py-30 mx-w-5xl mx-auto" id="about-me">
            ...
            <div className="grid md:grid-cols-2">
                ...
                <div>
                    ...
                    <p className="my-8">Although I don&apos;t have much experience in web development and programming, I consider myself a person who easily adapts to different languages and technologies. I am always willing to take on new challenges to solve complex problems and keep improving my technical and creative skills.</p>
                </div>
            </div>
        </div>
    );
